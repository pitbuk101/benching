WITH
	...
	FORECAST_3_MONTH_DATA AS (
		SELECT
			...
			ROUND(NEXT_PRICE, 2) AS NEXT_3_MONTH_QUARTER_PRICE,
			ROUND(
				(((NEXT_PRICE - PRICE) / PRICE) * COMPONENT_SHARE) * 100,
				2
			) AS NEXT_3_MONTH_COMPONENT_FORECAST,
			CONCAT (
				ROUND(
					(((NEXT_PRICE - PRICE) / PRICE) * COMPONENT_SHARE) * 100,
					2
				...
				'%'
			) AS NEXT_3_MONTH_COMPONENT_FORECAST_PERCENTAGE
		FROM
            SELECTED_QUARTER_DATA SQD
        JOIN NEXT_3_MONTHS_QUARTER_DATA NMD ON SQD.COMPONENT = NMD.COMPONENT
...
SELECT
	...
	SUM(NEXT_3_MONTH_QUARTER_PRICE) AS NEXT_3_MONTH_QUARTER_PRICE,
	SUM(NEXT_3_MONTH_COMPONENT_FORECAST) AS NEXT_3_MONTH_COMPONENT_FORECAST,
	ROUND(SUM(NEXT_3_MONTH_COMPONENT_FORECAST), 2) AS NEXT_3_MONTH_COMPONENT_FORECAST_PERCENTAGE
FROM
	FORECAST_3_MONTH_DATA