...
SELECT 
    YEAR,
    CATEGORY,
    AVG(ACTUAL_DELIVERABLE) AS ACTUAL_DELIVERABLE,
    ROUND(AVG(BENCHMARK_DELIVERABLE),2) AS BENCHMARK_DELIVERABLE,
    SUM(NUMBER_OF_HOURS) AS NUMBER_OF_HOURS,
    SUM(DELIVERABLE_BENCHMARKING_OPPORTUNITY) AS DELIVERABLE_BENCHMARKING_OPPORTUNITY
FROM 
    DELIVERABLE_DATA
GROUP BY
    YEAR,
