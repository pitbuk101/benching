...
SELECT 
    ...
    COUNT(CASE WHEN SUPPLIER_COUNT > 1 THEN MATERIAL_ID END) AS MULTI_SOURCE_COUNT,
    ROUND(SUM(CASE WHEN SUPPLIER_COUNT > 1 THEN TOTAL_SPEND ELSE 0 END),2) AS MULTI_SOURCE_SPEND
FROM MATERIAL_DATA
GROUP BY YEAR,
    CATEGORY
