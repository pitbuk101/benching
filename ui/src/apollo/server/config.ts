...
const defaultConfig = {
  ...
  // pg
  pgUrl: 'postgres://postgres:postgres@localhost:5432/admin_ui', // NOSONAR
  debug: false,
...
const config = {
  ...
  OIDC_CONFIG_URL: process.env.NEXT_PUBLIC_OIDC_CONFIG_URL,
  OIDC_FM: process.env.NEXT_PUBLIC_OIDC_FM,
  REDIRECT_BASE_URL: process.env.NEXT_PUBLIC_REDIRECT_BASE_URL,
  // pg
