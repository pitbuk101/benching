...
from ada.use_cases.idea_generation.dynamic_ideas.dynamic_ideas_graph import (
    ...
    region_data_retriever,
    plant_data_retriever,
    open_world_retriever
)
...
def create_langgraph() -> CompiledStateGraph:
    ...
    workflow.add_node("open_world_retriever",open_world_retriever)
    workflow.add_node("region_data_retriever", region_data_retriever)
    workflow.add_node("plant_data_retriever", plant_data_retriever)
    ...
    workflow.set_entry_point("open_world_retriever")
    ...
    workflow.add_conditional_edges(
        ...
        decide_retrieval_nodes,
        {
            ...
            "region_data_retriever": "region_data_retriever",
            "plant_data_retriever": "plant_data_retriever",
    ...
    workflow.add_edge("region_data_retriever","data_sink")
    workflow.add_edge("plant_data_retriever","data_sink")
    workflow.add_edge("get_all_analytics_data_retriever", "data_sink")
    workflow.add_edge("open_world_retriever", "data_sink")
