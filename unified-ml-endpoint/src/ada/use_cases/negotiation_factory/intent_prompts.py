...
def intent_prompt(
    ...
    argument_examples = """ "arguments" -
        ...
        Label: "arguments" \n
        Q: Make negotiation target to x in aboove arguments"
        Label: "arguments" \n
        Q: Generate arguments for the above counters
        Label: "arguments" \n
        Q: Change arguments
    ...
    user_query_examples = """ 
        ...
        Label: "user_questions" \n"
        Q. Learn more about the Supplier
        Label:"user_questions" \n 
        """
