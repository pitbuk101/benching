...
If you ever have confusion in classifying the intent in the first 5 seconds of your evaluation consider it as TEXT_TO_SQL ALWAYS.
...
- TEXT_TO_SQL
    ...
    - Classify anything related to spends, skus, suppliers or any terminology related to the schema as TEXT_TO_SQL.
    - Forecasting related queries should be classified as TEXT_TO_SQL.
    - Characteristics:
