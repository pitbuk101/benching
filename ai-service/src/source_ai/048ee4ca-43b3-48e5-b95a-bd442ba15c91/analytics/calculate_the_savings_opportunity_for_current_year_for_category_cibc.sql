...
SELECT 
    ...
    SD.SPEND,
    SD.QUANTITY,
    COALESCE(PD.PRICE_ARBITRAGE, 0) AS PRICE_ARBITRAGE,
    COALESCE(PC.CLEANSHEET_OPPORTUNITY,0) AS CLEANSHEET_OPPORTUNITY,
    COALESCE(LP.LPP_CORRUGATES_OPPORTUNITY,0) AS LPP_CORRUGATES_OPPORTUNITY,
    GREATEST(COALESCE(PD.PRICE_ARBITRAGE, 0),COALESCE(PC.CLEANSHEET_OPPORTUNITY,0), COALESCE(LP.LPP_CORRUGATES_OPPORTUNITY,0)) AS TOTAL_OPPORTUNITY
FROM SPEND_DATA SD
