-- Steps To Create SQL
-- STEP 1: In Plant Supplier Data, we get Year, Quarter, Category, Plant, and Supplier for the current year and quarter where the category is 'Valves'.
...
WITH AVERAGE_PRICE_DATA AS (
    ...
    FROM
        ...
        JOIN DATA.VT_DIM_PLANT AS PL ON PL.DIM_PLANT = IVP.DIM_PLANT
    WHERE
...
JOIN AVERAGE_SUPPLIER_PRICE_DATA ASPD ON APD.YEAR = ASPD.YEAR AND APD.CATEGORY = ASPD.CATEGORY AND APD.PLANT = ASPD.PLANT
