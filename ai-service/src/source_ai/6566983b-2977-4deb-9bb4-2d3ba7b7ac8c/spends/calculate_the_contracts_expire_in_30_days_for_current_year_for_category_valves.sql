...
SELECT
    ...
    PURCHASE_GROUP,
    CONTRACT_TYPE,
    DAYS_UNTIL_CONTRACT_EXPIRE,
    TO_DATE(CONTRACT_END_DATE, 'YYYYMMDD') AS CONTRACT_END_DATE,
    CONTRACT_NUMBER
FROM
    CONTRACT_DATA
WHERE LOWER(CATEGORY) = LOWER('Valves')
AND YEAR = YEAR(CURRENT_DATE)
AND DAYS_UNTIL_CONTRACT_EXPIRE >= 0 AND DAYS_UNTIL_CONTRACT_EXPIRE <= 30