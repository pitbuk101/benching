...
SELECT TD.YEAR, TD.CATEGORY, ROUND(COALESCE(TD.SPEND, 0), 2) AS SPEND, ROUND(COALESCE(CD.CONTRACTED_SPEND, 0), 2) AS CONTRACT_SPEND, ROUND(COALESCE(TD.SPEND-CD.CONTRACTED_SPEND, 0), 2) AS NON_CONTRACT_SPEND
