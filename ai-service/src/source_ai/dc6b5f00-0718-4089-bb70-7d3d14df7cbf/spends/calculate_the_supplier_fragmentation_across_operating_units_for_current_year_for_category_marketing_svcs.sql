...
SELECT 
    YEAR,
    CATEGORY,
    COUNT(SUPPLIER) AS TOTAL_OPERATING_UNITS,
    ROUND(SUM(TOTAL_SPEND),2) AS TOTAL_SPEND,
    COUNT(CASE WHEN OPERATING_UNITS_COUNT = 1 THEN SUPPLIER END) AS SINGLE_OPERATING_UNITS_COUNT,
    ROUND(SUM(CASE WHEN OPERATING_UNITS_COUNT = 1 THEN TOTAL_SPEND ELSE 0 END),2) AS SINGLE_OPERATING_UNITS_SPEND,
    COUNT(CASE WHEN OPERATING_UNITS_COUNT > 1 THEN SUPPLIER END) AS MULTI_OPERATING_UNITS_COUNT,
