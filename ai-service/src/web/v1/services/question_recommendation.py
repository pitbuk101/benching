...
class QuestionRecommendation:
    ...
    async def _validate_question(
        ...
        try:
            ...
            logger.critical(f"Recommendation: retrieval_result: {time.time() - start}")
            ...
            logger.critical(f"Recommendation: generated_sql: {time.time() - start}")
    ...
    async def _recommend(self, request: dict, input: Input):
        ...
        logger.critical(f"Recommendation: question_recommendation: {time.time() - start}")
