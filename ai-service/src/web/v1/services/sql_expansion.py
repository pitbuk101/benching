        ...
        **kwargs,
        ...
        try:
            ...
            if not self._is_stopped(query_id):
                ...
                logger.critical(f"sql_expansion: retrieval: {time.time() - start}")
            ...
            if not self._is_stopped(query_id):
                ...
                logger.critical(f"sql_expansion: generation: {time.time() - start}")
                ...
                if failed_dry_run_results := self._get_failed_dry_run_results(
                    ...
                    logger.critical(f"sql_expansion: correction: {time.time() - start}")
                ...
                if valid_generation_results:
                    ...
                    logger.critical(f"sql_expansion: summary: {time.time() - start}")
