    ...
    return ServiceContainer(
        ...
        ask_service=AskService(
            pipelines={
                ...
                "query_stablization": query_stablization.QueryStabilization(
                    **pipe_components["query_stablization"],
                ),
                "query_reranker": query_reranker.QueryReranking(
                    **pipe_components["query_reranker"],
                ),
