...
class ContractInformationFetchRequest(DocumentProcessRequest):
    def __init__(
        self,
        tenant_id: str,
        payload: dict,
    ...
    def validate(self):
        return super().is_all_true(
            [
                PreRequisiteCondition(self.request_body.get("use_case"), "Use case"),
    ...
    def process(self):
        ...
        use_case = self.request_body["use_case"]
        ...
        return {"document_id": doc_id, use_case: data[0][0]}
