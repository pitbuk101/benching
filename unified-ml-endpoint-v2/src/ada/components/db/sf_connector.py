...
class SnowflakeClient:
    ...
    def __init__(self, secret_name='Snowflake_sourceai_creds', tenant_id=None):
        ...
        """
        self.tenant_id = tenant_id  # Assign tenant_id to the instance
        # if self.tenant_id is not None:
        #     region = tenant_ids_region.get(self.tenant_id, None)
        #     if region is not None:
        #         self.connection_params = conn_params[region]  # Use the connection params for the region
        #     else:
        #         raise Exception("Invalid Tenant Id Passed", tenant_id)
        # else:
        #     raise Exception("Tenant Id is required", tenant_id)
        
        self.connection_params = conn_params['EU'] 
